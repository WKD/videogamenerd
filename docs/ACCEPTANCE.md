...
- [ ] **Review from the banner.** When favourites were auto-added, the banner reads **"N favourites added from Batocera · M to review"** and now offers **both** **Undo** and **Review…**; Review… opens the review, Undo reverses the add. *(Not shown this wave: a "Matching favourites… X of Y" progress line in Settings during the background auto-add — see LIMITATIONS.)*
