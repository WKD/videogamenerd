...
## 15. Batocera / ROM collection — idea, not scheduled *(owner, 2026-09-19)*
...
**First step when scheduled:** inspect the real files over the mount — two or three systems' `gamelist.xml` (like the Delicious file was inspected), then a reader + dry-run report — counts per system, played vs never played, how many collapse as duplicates, intersection size per platform — before any UI.
